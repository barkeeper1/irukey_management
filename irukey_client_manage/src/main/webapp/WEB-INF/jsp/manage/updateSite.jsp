...
<div class="container" style="margin-top:30px">
		...
		<form action="#">
		<div class="row">
			<h5 class="col-sm-11">구성도</h5>
			<button class="btn btn-link" onclick="location.href='${contextPath}/siteDetail.pr'">완료</button>
			<div id="drawing" class="border" ></div>
			<div class="btn-group col-sm-12" id="btns">
	...
	<div class="row" style="margin-top:30px;">
		...
		<table id="baseTable" class="table table-bordered infoTable" style="text-align:center; display:none">
			...
			<tr>
				<th>프로젝트 시작일</th>
				<td><input type="date" class="form-control" name="startDate" value="2019-01-01"></td>
				<th>프로젝트 종료일</th>
				<td><input type="date" class="form-control" name="endDate" value="2019-01-01"></td>
			</tr>
			<tr>
				<th>유지보수 기간</th>
				<td colspan="3"><input type="date" class="form-control" name="repairDate" value="2019-01-01"></td>
			</tr>
      	...
      	<table class="table" align="center" id="managerTable">
      		...
      		<tbody>
      			<tr>
      				...
      				<td><input type="radio" name="choice" value="0"></td>
      			</tr>
      		</tbody>
      		<tfoot>
      			<tr>
      				<td colspan="5">
	      				<button type="button" class="btn btn-light col-sm-5" id="addManager">행 추가하기</button>
	      				<button type="button" class="btn btn-secondary col-sm-5" id="deleteManager">행 삭제하기</button>
      				</td>
      			</tr>
      		</tfoot>
      	</table>
